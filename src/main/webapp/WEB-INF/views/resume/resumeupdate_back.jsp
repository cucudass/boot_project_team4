        ...
        <form name="resumeupfrm" method="POST" action="resumeupdate" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-container">
                    ...
                    <div class="input-container w100">
                        <select id="gender" class="" required name="gendr">
            ...
            <div class="form-section">
                ...
                <div class="form-container">
                    ...
                    <div class="input-container w100">
                    	<fmt:formatDate value="${resumeselect.sdate}" pattern="yyyy.MM" var="formatsdate" />
                        <input type="text" id="sDate" name="sdate" placeholder=" " required maxlength="8" value="${formatsdate }" onkeyup="formatDateym(event)"/>
                        <label for="sDate">입학년월 <span class="c-r">*</span></label>
                    </div>
                    <div class="input-container w100">
                    	<fmt:formatDate value="${resumeselect.edate}" pattern="yyyy.MM" var="formatedate" />
                        <input type="text" id="eDate" name="edate" placeholder=" " required maxlength="8" value="${formatedate }" onkeyup="formatDateym(event)"/>
